...
public class LoginTestSeeker extends Page {
	...
	public void test(String id,String pwd) throws Exception
	{
		...
		if(actmsg != null)
		{
			Connection con=POIConfig.makeConnection("c:\\core\\selenium\\Book2.xls"); // have to make connection as before data is added to array from getData() yaha connection open nahi hai
	...
	public static Object[][] getData() throws Exception{
		...
		return utility.POIConfig.getData("c:\\core\\selenium\\Book2.xls","Sheet1");
	}
